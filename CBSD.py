...
class CBSD(object):
    def __init__(self):
        ...
        self.sas_url_base = '' # enter your SAS URL
        self.header = {"content-type" : "application/json",}
        self.cert_file_path = '' # point to your vendor certificate
        self.key_file_path = '' # point to your vendor certificate
        self.cert = (self.cert_file_path, self.key_file_path)
        self.ca_cert_file_path = '' # point to your CA certificate
